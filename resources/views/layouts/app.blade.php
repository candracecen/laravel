        ...
        <ul class="menu-inner py-1">
          ...
          <li class="menu-item">
            <a href="/broadcast" class="menu-link">
              ...
              <div data-i18n="Analytics">Broadcast</div>
            </a>
          </li>
          <li class="menu-item">
            <a href="/chat-bot" class="menu-link">
              <i class="menu-icon tf-icons bx bx-message-rounded-detail"></i>
              <div data-i18n="Analytics">Chat bot</div>
            </a>
          </li>
          <li class="menu-item">
            <a href="/terkirim" class="menu-link">
              <i class="menu-icon tf-icons bx bx-send"></i>
              <div data-i18n="Analytics">Pesan Terkirim</div>
            </a>
          </li>
